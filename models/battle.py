...
def computeDamageModifier(attack, pokemon1, pokemon2) -> float:
    stab = 1
...
def computeDamage(attack, pokemon1, pokemon2) -> float:
    ...
    return damage_without_modifier * computeDamageModifier(attack, pokemon1, pokemon2)
...
class Battle:
    ...
    def executeTurn(self, turn):
        ...
        self.pokemon2.current_hp -= computeDamage(attack1, self.pokemon1, self.pokemon2)
        self.pokemon1.current_hp -= computeDamage(attack2, self.pokemon2, self.pokemon1)
